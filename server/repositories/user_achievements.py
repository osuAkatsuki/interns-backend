...
async def create(
    ...
    user_achievement = await clients.database.fetch_one(
        query=f"""\
            INSERT INTO user_achievements (achievement_id, account_id, created_at)
            VALUES (:achievement_id, :account_id, :created_at)
